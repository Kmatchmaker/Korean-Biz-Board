...
st.caption("2026년 2월 17일 실시간 업데이트")

# [주의] 모든 링크는 반드시 https:// 로 시작해야 외부로 연결됩니다.
data = [
...
# 링크 클릭 시 외부 브라우저로 확실히 보내는 설정
st.data_editor(
    df,
    column_config={
        "Link": st.column_config.Link_column(
            "공식 출처 원문",
            help="클릭하면 해당 기관/기업의 공식 발표 페이지로 이동합니다.",
            validate="^https?://",
            display_text="원문 보기"
        )
    },
...
st.success("✅ 이제 '원문 보기'를 클릭하면 외부 사이트로 직접 연결됩니다.")
